                ...
                <?php foreach ($notes as $note) : ?>
                    <tr>
                        ...
                        <td class="px-6 py-2 whitespace-nowrap flex items-center" data-id="10">
                            <button
                                    @click="showNote(<?= htmlspecialchars(json_encode($note), ENT_QUOTES, 'UTF-8') ?>)"
                            ...
                            <form method="post">
                                ...
                                <button name="__method" formaction="/notes" value="DELETE" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-[16px] w-10"
                                   data-id="15">
                                    <input type="hidden" name="id" value="<?= $note['id']?>">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-2xl" x-text="currentNote?.body_note"></p>
                            </div>
                        </div>
                    </div>
                </div>
